...
def mutacion_gaussiana(cromosoma, sigma=0.1):
    ...
    for i in range(39):
        ...
        nuevos_pesos = [max(0.0, p + random.gauss(0, sigma)) for p in pesos]
...
def algoritmo_genetico(generaciones=150, tam_poblacion=100):
    ...
    for gen in range(generaciones):
        ...
        while len(nueva_poblacion) < tam_poblacion:
            ...
            #Selecciona 1 y comenta los demás para ir verificar los resuldos
            #hijo = mutacion_gaussiana(hijo,sigma=0.01)
